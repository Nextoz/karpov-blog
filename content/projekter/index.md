...
## DCAB — Det Centrale Almene Boligregister

**Område:** Offentlig IT, backend, data, registre  
**Teknologier:** .NET, C#, ASP.NET, Blazor, MSSQL, Azure DevOps

DCAB var et nationalt registersystem inden for den almene boligsektor. Projektet krævede struktur, datakvalitet, forretningsforståelse og evnen til at arbejde med komplekse domænemodeller.

### Mit fokus

- Backend-udvikling i .NET
...
**Område:** Identity, authentication, security  
**Teknologier:** IdentityServer, OIDC, MFA, FIDO2, .NET

SSOIDP er et identitets- og loginprojekt med fokus på moderne authentication flows, OpenID Connect og stærkere sikkerhed omkring brugerlogin.

### Mit fokus

- Identity flows og loginarkitektur
...
- Azure DevOps og CI/CD
- .NET, C# og backend-systemer
- Kubernetes, Docker, Helm og KEDA
- Platform engineering og driftbarhed
